 ...
 * Enhanced version with 30 tasks across 5 hierarchy levels
 */
...
/**
 * 30 tasks organized in 5 hierarchy levels
 * Level 1: Main phases (5 tasks)
 * Level 2: Sub-phases (8 tasks)
 * Level 3: Major activities (9 tasks)
 * Level 4: Specific tasks (6 tasks)
 * Level 5: Detailed subtasks (2 tasks)
 */
export const mockTasks = [
  // ===== LEVEL 1: Main Project Phases (5 tasks) =====

  {
    ...
    priority: '高',
    status: '已完成',
    description: '完成项目立项、团队组建、需求调研和项目规划工作',
    parentId: null,
    children: [
      {
        // ===== LEVEL 2 =====
        ...
        children: [
          {
            ...
            priority: '高',
            status: '已完成',
            description: '完成项目技术可行性、经济可行性和操作可行性分析',
            parentId: 't1-1',
            children: [
              {
                // ===== LEVEL 4 =====
...

  {
    ...
    priority: '高',
    status: '已完成',
    description: '完成系统需求分析、用户调研和需求规格说明',
    parentId: null,
    children: [
      {
        id: 't2-1',
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            priority: '中',
            status: '已完成',
            description: '分析性能、安全、可维护性等非功能需求',
            parentId: 't2-2',
            children: []
          }
        ]
...
// Helper function to count tasks by level
function countTasksByLevel(tasks, targetLevel, currentLevel = 1) {
  let count = 0
